...
awful.screen.connect_for_each_screen(function(s)
    ...
    --set_wallpaper(s)
    -- create a wiBar
      s.mywibox = awful.wibar({ position = "top", screen = s, height = 20, ontop = false, type = "normal" }) --bg = theme.bg_normal, fg = theme.fg_normal })
...
-- {{{ Personal keybindings
    ...
    awful.key({ modkey  }, "d", function ()
        awful.spawn(string.format("dmenu_run -i -nb '#191919' -nf '#fea63c' -sf '#191919' -fn 'Hack:bold:pixelsize=14'",
  ...
  --SYSTEM_Control (mod + Function)
     awful.key({ modkey }, "F1", function () awful.util.spawn( "pavucontrol" ) end,
        {description = "pulseaudio" , group = "gui apps" }),
     awful.key({ modkey }, "F2", function () awful.util.spawn( "blueman-manager" ) end,
        {description = "bluetooth" , group = "gui apps" }),
     awful.key({ modkey }, "F3", function () awful.util.spawn( "xfce4-power-manager-settings" ) end,
        {description = "power manager" , group = "gui apps" }),
     awful.key({ modkey }, "F4", function () awful.util.spawn( "font-manager" ) end,
        {description = "font-manager" , group = "gui apps" }),
...
--{{{ My applications (Alt+Key)
    awful.key({ altkey }, "a", function () awful.util.spawn( "alacritty" ) end,
        {description = "alacritty" , group = "terminal apps" }),
    awful.key({ altkey }, "c", function () awful.util.spawn( editorgui ) end,
        {description = "code" , group = "gui apps" }),
    awful.key({ altkey  }, "t", function () awful.util.spawn( filemanager ) end,
        {description = "thunar" , group = "gui apps" }),
    awful.key({ altkey }, "n", function () awful.util.spawn( "nitrogen" ) end,
        {description = "nitrogen" , group = "gui apps" }),
    awful.key({ altkey  }, "e", function () awful.util.spawn( terminal.." -e nvim " ) end,
        {description = "nvim" , group = "development" }),
    awful.key({ altkey  }, "f", function () awful.util.spawn( "firefox" ) end,
        {description = "firefox" , group = "gui apps" }),
    awful.key({ altkey  }, "p", function () awful.util.spawn( "pamac-manager" ) end,
        {description = "pacmac" , group = "gui apps" }),
    awful.key({ altkey }, "s", function () awful.util.spawn( "xfce4-screenshooter" ) end,
        {description = "xfce4-screenshooter" , group = "gui apps" }),
    awful.key({ altkey }, "q", function () awful.util.spawn( "qutebrowser" ) end,
        {description = "qutebrowser" , group = "browser" }),
    awful.key({ altkey }, "i", function () awful.util.spawn( "loimpress" ) end,
        {description = "Libreoffice Impress" , group = "gui apps" }),
    awful.key({ altkey  }, "r", function () awful.util.spawn( terminal.." -e ranger" ) end,
        {description = "ranger" , group = "terminal apps" }),
    awful.key({ altkey }, "l", function () awful.util.spawn( "lxappearance" ) end,
        {description = "lapperance" , group = "gui apps" }),
    awful.key({ altkey  }, "g", function () awful.util.spawn( terminal.." -e gotop " ) end,
        {description = "gotop" , group = "terminal apps" }),
    awful.key({ altkey  }, "v", function () awful.util.spawn( virtualmachine ) end,
        {description = "virtual box" , group = "gui apps" }),
     awful.key({ altkey  }, "z", function () awful.util.spawn( "zoom" ) end,
        {description = "zoom" , group = "gui apps" }),
     awful.key({ altkey  }, "x", function () awful.util.spawn( "konsole" ) end,
        {description = "konsole" , group = "gui apps" }),
     awful.key({ altkey  }, "h", function () awful.util.spawn( "haruna" ) end,
        {description = "haruna" , group = "gui apps" }),
--}}}
...
--{{{ Gaps Toggle
 ...
 --For Floating clients
    --gap
    awful.key({altkey, "Control" }, "d", function () awful.client.moveresize(20, 20, -40, -40) end,
              {description = "decrease size", group = "tag"}),
    awful.key({altkey, "Control" }, "i", function () awful.client.moveresize(-20, -20, 40, 40) end,
              {description = "increase size", group = "tag"}),

    --move
    awful.key({altkey, "Control"}, "j", function () awful.client.moveresize(0, 20, 0, 0) end,
              {description = "Client move down", group = "tag"}),
    awful.key({altkey, "Control" }, "k", function () awful.client.moveresize(0, -20, 0, 0) end,
              {descrition = "client move up", group = "tag"}),
    awful.key({altkey, "Control" }, "h", function () awful.client.moveresize(-20, 0, 0, 0) end,
              {description = "move left", group = "tag"}),
    awful.key({altkey, "Control" }, "l", function () awful.client.moveresize(20, 0, 0, 0) end,
...
awful.rules.rules = {
    ...
    { rule = { class = "Conky" },
          properties = { below = true, floating = true } },
...
--          properties = { callback = function (c) c.maximized = false end } },
    ...
    { rule_any = {
        ...
        role = {
          ...
          "pop-up",
          "Preferences",-- e.g. Google Chrome's (detached) Developer Tools.
          "setup",
        }
