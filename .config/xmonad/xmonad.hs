...
myFont :: String
myFont = "xft:Cascadia Code:SemiBold:size=10:antialias=true:hinting=true"
...
myBrowser :: String
myBrowser = "firefox "  -- Sets a firefox as browser
...
myKeys c =
  ...
  , ("M-d", addName "Launch dmenu"              $ spawn "dmenu_run -i -nb '#282a36' -nf '#bd93f9' -sb '#bd93f9' -sf '#282a36' -fn 'NotoMonoRegular:bold:pixelsize=14'")
  , ("M-r", addName "Launch rofi"               $ spawn "rofi -show run")
  , ("M-M1-h", addName "Launch htop"            $ spawn (myTerminal ++ " -e htop"))
  , ("M-v", addName "Launch PULSEAudio volume control"        $ spawn "pavucontrol")
  , ("M-<F2>", addName "Launch Blueman"           $ spawn "blueman-manager")
  , ("M-<F3>", addName "Launch PowerManager"      $ spawn "xfce4-power-manager-settings")
  , ("M-<F4>", addName "Launch FontManager"       $ spawn "font-manager")
  ]

  ^++^ subKeys "Applications"
  [ ("M1-a", addName "Launch Alacritty"         $ spawn "alacritty")
  , ("M1-b", addName "Launch Brave"             $ spawn "brave")
  , ("M1-c", addName "Launch VScode"            $ spawn "code")
  , ("M1-e", addName "Launch Neovim"            $ spawn (myEditor))
  , ("M1-f", addName "Launch Firefox"           $ spawn (myBrowser))
  , ("M1-h", addName "Launch Haruna"            $ spawn "haruna")
  , ("M1-l", addName "Launch lxappearance"      $ spawn "lxappearance")
  , ("M1-n", addName "Launch nitrogen"          $ spawn "nitrogen")
  , ("M1-p", addName "Launch pamac"             $ spawn "pamac-manager")
  , ("M1-r", addName "Launch ranger"            $ spawn "kitty -e ranger")
  , ("M1-t", addName "Launch FileManager"       $ spawn "thunar")
  ...
  [ ("M-C-d", addName "Shrink window"               $ sendMessage Shrink)
  , ("M-C-i", addName "Expand window"               $ sendMessage Expand)
  ...
  [ ("M-S-d", addName "Decrease window spacing" $ decWindowSpacing 2)
  , ("M-S-i", addName "Increase window spacing" $ incWindowSpacing 2)
  , ("M-M1-d", addName "Decrease screen spacing" $ decScreenSpacing 2)
  , ("M-M1-i", addName "Increase screen spacing" $ incScreenSpacing 2)]
  ...
  , ("<XF86MonBrightnessDown>", addName "dec brightness"    $ spawn "light -U 10")
...
main = do
  ...
  xmonad $ addDescrKeys' ((mod4Mask, xK_F1), showKeybindings) myKeys $ ewmh $ docks $ def
    ...
    , logHook = dynamicLogWithPP $  filterOutWsPP [scratchpadWorkspaceTag] $ xmobarPP
        ...
        , ppCurrent = xmobarColor color06 "" . wrap "[" "]" -- Current Workspace
