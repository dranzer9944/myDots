...
local function factory(args)
    ...
    pulse.devicetype = args.devicetype or "@DEFAULT_SINK"
    pulse.cmd = args.cmd or "pactl" .. pulse.devicetype .. "s | sed -n -e '/*/,$!d' -e '/index/p' -e '/base volume/d' -e '/volume:/p' -e '/muted:/p' -e '/device\\.string/p'"
